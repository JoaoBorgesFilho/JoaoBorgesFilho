...
- 🎵 Project Spotify — aplicação full-stack, com front-end desenvolvido em React e Vite e back-end em Node.js com Express, utilizando MongoDB para persistência de dados de artistas e músicas. O front-end consome uma API REST própria desenvolvida no back-end utilizando Axios.
